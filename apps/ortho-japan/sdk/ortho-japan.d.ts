...
export interface OrthoJapanMap {
	...
	overlay(url: string, opts?: { name?: string; opts?: Record<string, unknown> }): { name: string; el: HTMLCanvasElement; post(data: unknown, transfer?: Transferable[]): void; remove(): void };
