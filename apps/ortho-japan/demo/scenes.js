...
export default { mobile:-1.2,
	// PLATEAU 先読みの明示リスト（この順に▶の瞬間から焼く）。名は public/plateau-sets.json のカタログ名そのまま。
	// 未指定なら台本の停止位置から自動導出（重心タイブレーク）だが、明示＝決定的＝台本と一緒に手で調整できる。
	// 橋梁（「◯◯（橋梁）」）はサイズ一桁小さい割にシーンの主役（レインボーブリッジ等）＝中心区とペアで前へ。
	plateau: ["千代田区（橋梁）", "千代田区", "中央区（橋梁）", "中央区", "港区（橋梁）", "港区",
		"大田区", "大田区（橋梁）", "墨田区", "墨田区（橋梁）", "新宿区",
		"横浜西区", "横浜市（橋梁）", "大阪中央区", "大阪市（橋梁）", "京都中京区",
		"荒川区", "横浜中区", "京都右京区"],
	scenes: [
		{ title: "Blank Map of Japan", jp: "白地図の日本", view: "#6/37/137/l=/c=mono", slide: slideStart },
		{ title: "The Earth is Round", jp: "地球は丸い", view: "#4/37/137/l=/c=mono", slide:"orthographic" },
		{ title: "Blank Map", jp: "白地図", view: "#9.14/35.57334/138.11457/0r/l=/c=mono", slide:"4 map styles:\ngsi・dark・sepia・mono(default)" },
		{ title: "GSI Style", jp: "地理院地図", view: "#9.14/35.57334/138.11457/0r/l=place.terrain.rail.road.facility/c=gsi" },
		{ title: "Dark Mode", jp: "ダーク・モード", view: "#9.14/35.57334/138.11457/0r/l=place.terrain.rail.road.facility/c=dark" },
		{ title: "Sepia Mode", jp: "セピア・モード", view: "#9.14/35.57334/138.11457/0r/l=place.terrain/c=sepia" },
		{ title: "Light Mode", jp: "淡色地図", view: "#9.14/35.57334/138.11457/0r/l=place.terrain.rail.road.facility/c=mono"},
		...
		{ title: "Contour Lines", jp: "等高線", view: "#13.01/35.44874/138.73829/0t/0r/l=terrain", slide:"Hey! stand up, please."},
		{ title: "Mt. Fuji", jp: "富士山", view: "#13.01/35.44874/138.73829/73t/0r/l=terrain" },
		{ title: "Yatsugatake", jp: "八ヶ岳", glide: "#13.50/36.01337/138.35989/75t/-2r/l=terrain" },
		...
		{ title: "Tokyo Station", jp: "東京駅", view: "#19.87/35.68209/139.76340/75t/86r/l=", slide: "PLATEAU: 3D City Models\nby MLIT" },
		...
		{ title: "Osaka Castle", jp: "大阪城", view: "#18.89/34.68787/135.52485/61t/-38r/l=" },
		...
		{ title: "Earth & Celestial Sphere", jp: "地球と天体", pre: "#2/35.01410/135.74622/67t/20r/l=", glide: "#2/35.01410/135.74622/67t/20r/l=sky" },
		{ title: "Finale", jp: "最後に", view: "#6/37/137/l=/c=mono", slide: slideEnd },
	],
};
