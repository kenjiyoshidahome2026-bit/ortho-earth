...
// SDK の公開面はこのファイル＝default orthoJapan・createGlobe・geopbf・Marker・Popup（型は sdk/ortho-japan.d.ts）。
import { createGlobe, geopbf, Marker, Popup } from "@ortho-earth/globe";   // 地球儀のホスト（packages/globe・S4 2026-09-23）
...
export { createGlobe, geopbf, Marker, Popup };
