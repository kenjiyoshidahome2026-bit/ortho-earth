...
// 地域の選び方（URL：/nl/・?nl=1・既定は日本）はここだけが知る。ホスト（globe.js の createGlobe）は opts.region しか見ない＝地域名を知らない。
// SDK の公開面はこのファイル＝default orthoJapan・createGlobe・geopbf（型は sdk/ortho-japan.d.ts）。
import { createGlobe, geopbf } from "./globe.js";
