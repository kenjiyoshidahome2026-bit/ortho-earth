...
export { GLTFLoader, postProcessGLTF } from "@loaders.gl/gltf";   // GLTFLoader 単体は生の json＋buffers を返す＝後処理（accessor→typed array・node/mesh の参照解決）は明示に呼ぶ（Tiles3DLoader は内部で呼んでいる）
