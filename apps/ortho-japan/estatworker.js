...
import { buildGeoJSONOverlay, pointInFeature } from "@ortho-earth/core/geojson";   // index.js 経由だと gl/renderer.js→glsl.js（60 KB）が worker ビルドの共有チャンクに乗り WebGPU 機でも起動時に読まれる（2026-09-14）
