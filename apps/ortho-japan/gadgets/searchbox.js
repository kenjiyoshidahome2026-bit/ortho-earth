...
export function search(opts = {}) {
	...
	box.id = "search";
	box.innerHTML = `
		<input id="search-in" type="search" placeholder="${t("Search places and addresses")}" aria-label="${t("Search places and addresses")}" autocomplete="off" spellcheck="false">
		<button id="search-btn" data-tip="${t("Search places and addresses (/)")}" aria-label="${t("Search places and addresses")}">
