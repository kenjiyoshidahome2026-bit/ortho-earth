...
const WHITELIST = ["plateau-sets.json", "airports.json", "plateau-landmarks.json", "plateau-exclude.json", "koppen-clim.png"];   // plateau-exclude＝建物除外表（app.js の ASSET_BASE fetch・2026-09-10 追加）
