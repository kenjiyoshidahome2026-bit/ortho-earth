...
try {
	...
	fail = 0;
	const ALL = ["t-webgpu", "t-extrude-drape?gl2=1&s=plane", "t-extrude-drape?gl2=1&s=drape", "t-aatrans", "t-gintgpu", "t-gintgpu?gintsb=0", "t-gintmulti", "t-gintlayers", "t-gintlayers?gl2=1", "t-meshfs", "t-baselane", "t-backfill", "t-anchorfill", "t-rectlook", "t-zoomfill", "t-bld?gl2=1", "t-mesh?gl2=1&loadmax=1", "t-raster", "t-gndfaces"];   // t-raster＝画像タイル層の WGSL 経路（配列 UBO の dynamic offset・per-tile bind group）
