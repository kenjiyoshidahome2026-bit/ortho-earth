...
try {
	...
	fail = 0;
	const ALL = ["t-webgpu", "t-aatrans", "t-gintgpu", "t-gintgpu?gintsb=0", "t-gintmulti", "t-gintlayers", "t-gintlayers?gl2=1", "t-plateaufs", "t-baselane", "t-backfill", "t-anchorfill", "t-rectlook", "t-zoomfill", "t-bld?gl2=1", "t-plateau?gl2=1&loadmax=1", "t-raster", "t-gndfaces"];   // t-raster＝画像タイル層の WGSL 経路（配列 UBO の dynamic offset・per-tile bind group）
