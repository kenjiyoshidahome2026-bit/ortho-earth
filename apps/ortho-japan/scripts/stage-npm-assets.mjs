...
const WHITELIST = ["plateau-sets.json", "airports.json", "plateau-landmarks.json", "plateau-exclude.json", "koppen-clim.png", "llms.txt"];   // plateau-exclude＝建物除外表（1.2KB・無いと 404 を黙って捨て除外なしで動く＝npm 1.0.3 検札で発見）
