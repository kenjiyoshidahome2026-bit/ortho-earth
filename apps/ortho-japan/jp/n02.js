...
// 在来線区間の緯度帯クリップで仲間に入れる。日本の知識＝地域宣言と同じ jp/ の下（本人裁定 2026-09-17）。app.js の一塊（旧 1392〜1471 行）を
// **動作を変えずに**ここへ移した（2026-09-17）。地域宣言（jp/region.js の rail）から注入＝/nl/ では作らない（2026-09-22）。
