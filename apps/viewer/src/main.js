import myEarth from 'ortho-map';
const map = await myEarth({gadgets:false});
...
// map.explain("<h3>Ortho Earth Demo</h3><p>正投影法の地図(Ortho Earth)のデモページです。このプラットフォーム上に、いろんな機能を実装することが可能です。</p>");
