...
const MAFF_DONE_FILE  = 'maff-geopbf-progress.json';
const ESTAT_DONE_FILE = 'estat-progress.json';
...
// ── MAFF カタログ ──────────────────────────────────────────────────────────
const maffManifest = JSON.parse(readFileSync('maff-manifest.json'));
...
// ── e-stat カタログ ────────────────────────────────────────────────────────
let estatManifest = [];
const ESTAT_MANIFEST_PATHS = ['estat-manifest.json', '../../estat-manifest.json', '../../../estat-manifest.json'];
