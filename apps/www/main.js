...
// Section tabs (Demos / Technologies) — wired early so they respond before the globe finishes loading.
// Client-side only: toggles panels, keeps the live globe behind. #technologies deep-links the Tech tab.
