...
// エディタ本体は ortho-japan のガジェット（gadgets/geoedit）になり、ページは /japan/geoedit.html（ortho-japan Worker が配る）。
...
export default {
	async fetch(req) {
		...
		return Response.redirect(`${url.origin}/japan/geoedit.html${url.search}`, 301);
	},
};
