...
// 海・湖＝ortho-core worldpal の sea（japan の全球ハイプソと面一の水面）・陸＝quiet-mono の紙・海岸線＝japan mono の coastLine
...
export const LAYERS = [
	...
	},
	{
		...
		pointStyles: [{ color: rgb("#2b6e9e"), size: 5 }],
		order: { points: 80 },
	},
	{
		...
		pointStyles: [{ color: rgb("#6a3d9a"), size: 7 }, { color: rgb("#8b6bb0"), size: 5 }],
		order: { points: 81 },
	},
];
