...
export const THEMES = {
	...
	mono: {
		...
		road: "#d9a86c", rail: "#7d7f86", port: "#2b6e9e", airport: "#6a3d9a", airportMinor: "#8b6bb0",
	...
	dark: {
		...
		road: "#8a6a44", rail: "#5a5c62", port: "#4a86a8", airport: "#a98bd0", airportMinor: "#7d68a0",
	...
	gsi: {
		...
		disputed: ["#9a6e90", 0.28], disputedLine: ["#8a5f80", 0.9],
		road: "#e0a86c", rail: "#7d7f86", port: "#2b6e9e", airport: "#601986", airportMinor: "#8b6bb0",
	...
	sepia: {
		...
		road: "#c08a4a", rail: "#8a7a62", port: "#5a7a8a", airport: "#7a5568", airportMinor: "#a08494",
