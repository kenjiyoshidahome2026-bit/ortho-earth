...
const TERRAIN_CATEGORIES = new Set(["continent", "plate", "ocean", "current", "region", "shield", "sea", "bay", "strait", "reef", "island", "islands", "peninsula", "cape", "isthmus", "range", "peak", "volcano", "pass", "plateau", "plain", "basin", "valley", "desert", "saltflat", "delta", "wetland", "ice", "lake", "river", "waterfall", "canal", "trench", "ridge", "pole"]);
