...
export const SEED_FILES = ["nations.csv", "cities.csv", "conflicts.json", "overrides.json", "capital-notes.json", "aliases.json", "ja.json"];
export async function loadSeed(read) {
	...
	return { nations, cities, conflicts, overrides, capitalNotes, aliases, ja, ui, langs: ui.langs.map(l => l.code) };
}
