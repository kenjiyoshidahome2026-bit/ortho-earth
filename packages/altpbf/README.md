...
Fetching, caching and height lookup are not part of this package. The ortho-earth engine does that in
[`@ortho-earth/core/elevation`](https://www.npmjs.com/package/@ortho-earth/core) (`createGetHeight`, `createTileLoader`),
which reads tiles written in this format.
