...
const ALL_PAGES = ["t-gintlod", "t-gintembed", "t-gintmultigl", "t-gintswap", "t-gintdepth", "t-qr",
	...
	"t-overlaydepth", "t-overlaydepth?lowmem=1", "t-mlcompat?g=layers", "t-mlcompat?g=style"];   // t-mlcompat＝MapLibre 互換の爪車（tests/mlcompat-known.json・台帳 maplibre-compat.md）　t-overlaydepth＝オーバーレイへシーンの深度（#47）・lowmem=1＝LOW_MEM では作らない
...
const REALTIME = new Set(["t-anno", "t-camera", "t-mllayers", "t-mlstyle", "t-linedeco", "t-tiles3d", "t-marker", "t-request", "t-sunshadow", "t-dem", "t-viewshed", "t-clock", "t-bootview", "t-overlaydepth", "t-mlcompat"]);
const LONG = { "t-request": 180, "t-linedeco": 150, "t-dem": 170, "t-bootview": 240, "t-overlaydepth": 150, "t-mlcompat": 150 };   // t-bootview＝5 回起動し直す   // 段が多い実描画＝枠を広げる
