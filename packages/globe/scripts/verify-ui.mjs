...
const REALTIME = new Set(["t-anno", "t-camera", "t-mllayers", "t-mlstyle", "t-linedeco", "t-tiles3d", "t-marker", "t-request", "t-sunshadow", "t-dem", "t-viewshed", "t-clock", "t-bootview"]);
const LONG = { "t-request": 180, "t-linedeco": 150, "t-dem": 170, "t-bootview": 240 };   // t-bootview＝5 回起動し直す   // 段が多い実描画＝枠を広げる
