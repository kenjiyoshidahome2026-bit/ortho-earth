...
import { leftPanel, rightPanel, layers, zoom, north, cpos, full, shot, print, measure, constellation, close } from "./modules/gadget1.js"
...
export function createGadgets(map) {
	...
	const gadgets = {
		leftPanel, rightPanel, layers, zoom, north, cpos, full, shot, print, measure, constellation, close,// (1)
